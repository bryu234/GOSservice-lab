...
PROJECT_CONTAINERS = gos_arm_adm gos_arm_user gos_dns gos_mail gos_siem_certs gos_siem_manager gos_siem_indexer gos_siem_dashboard gos_web gos_db
...
PROJECT_IMAGES = gosservice_lab-gos_arm_adm gosservice_lab-gos_arm_user gosservice_lab-gos_dns gosservice_lab-gos_mail gosservice_lab-gos_web
...
.PHONY: help env check-ports check-wazuh-prereqs wazuh-certs config build up up-vm up-local down ps logs restart shell-adm shell-user shell-mail shell-siem-manager shell-siem-indexer shell-siem-dashboard ssh-adm ssh-user rdp-info clean-volumes clean-all
