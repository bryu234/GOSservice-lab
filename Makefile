...
PROJECT_CONTAINERS = gos_arm_adm gos_arm_user gos_dns gos_mail gos_siem_certs gos_siem_manager gos_siem_indexer gos_siem_dashboard gos_web gos_db gos_db_seed
...
check-ports: env
	...
	for item in "ADM_RDP_HOST_PORT:adm RDP" "ADM_SSH_HOST_PORT:adm SSH" "USER_RDP_HOST_PORT:user RDP" "USER_SSH_HOST_PORT:user SSH" "ESPOCRM_HTTP_HOST_PORT:EspoCRM HTTP" "WAZUH_DASHBOARD_HOST_PORT:Wazuh Dashboard HTTPS"; do \
...
up: check-wazuh-prereqs wazuh-certs check-ports
...
up-local: check-wazuh-prereqs wazuh-certs check-ports
